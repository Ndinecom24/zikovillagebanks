                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    @if($task->priority)
                                        <span
                                            style="font-size: 0.78rem; font-weight: 600; color: {{ $task->priority_color }}; background: {{ $task->priority_color }}15; padding: 0.15rem 0.5rem; border-radius: 8px;">{{ ucfirst($task->priority) }}</span>
                                    @else
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    @if($task->due_date)
                                        <span
                                            style="font-size: 0.82rem; font-weight: 600; color: {{ $task->is_overdue ? '#dc2626' : '#374151' }};">
                            ...
                            @if($module)
                                <div
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 0.35rem;">
                                        ...
                                        <span
                                            style="font-size: 0.82rem; font-weight: 600; color: #1a2332;">{{ $module->name }}</span>
                                    </div>
                                </div>
                            @endif
                        </div>

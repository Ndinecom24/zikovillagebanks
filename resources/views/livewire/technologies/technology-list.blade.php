            ...
            <div class="card z-card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap" style="gap: 0.75rem;">
                    <h3>
                        ...
                        <span class="z-count ml-2">{{ $technologies->total() }}</span>
                    </h3>
        ...
        <div class="modal-dialog modal-dialog-centered" style="max-width: 500px;">
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 1.5rem;">
                    ...
                    <input type="text" wire:model.defer="newTechnology" class="form-control z-input"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="z-stat-card">
                                <div class="z-stat-num">{{ $detailTechnology->id }}</div>
                                <div class="z-stat-label-sm">ID</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="z-stat-card">
                                <div class="z-stat-num">{{ count($detailIpps) }}</div>
                                <div class="z-stat-label-sm">IPPs Using</div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="z-stat-card">
                                <div class="z-stat-num">
                                    {{ $detailTechnology->created_at ? $detailTechnology->created_at->diffForHumans(null, true) : '—' }}
                                </div>
                                <div class="z-stat-label-sm">Age</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="z-card mb-3">
                        <div class="row">
                            <div class="col-sm-6 mb-2">
                                <div class="z-detail-label">Technology Name</div>
                            ...
                            <div class="col-sm-6 mb-2">
                                ...
                                <div class="z-detail-value" style="font-size: 0.88rem;">

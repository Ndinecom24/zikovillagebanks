...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .code{font-size:5rem;font-weight:800;color:#dc2626;line-height:1;margin-bottom:.5rem}
...
<body>
    <div class="card">
        ...
        <p class="desc">We're experiencing a technical issue. Our team has been notified. Please try again in a few moments.</p>

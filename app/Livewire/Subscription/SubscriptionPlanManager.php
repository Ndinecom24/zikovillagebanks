...
class SubscriptionPlanManager extends Component
{
    ...
    public $discountStartsAt = '';
    public $discountEndsAt = '';
    ...
    protected function rules()
    {
        ...
        return [
            ...
            'discountType'   => 'required|in:none,percentage,fixed',
            'discountValue'  => 'nullable|numeric|min:0',
            'discountStartsAt' => 'nullable|date',
            'discountEndsAt'   => 'nullable|date|after_or_equal:discountStartsAt',
            'discountLabel'  => 'nullable|string|max:100',
        ];
    }
    ...
    public function openEdit($id)
    {
        ...
        $this->discountType     = $plan->discount_type ?? 'none';
        $this->discountValue    = $plan->discount_value ?? '';
        $this->discountStartsAt = $plan->discount_starts_at ? $plan->discount_starts_at->format('Y-m-d\TH:i') : '';
        $this->discountEndsAt   = $plan->discount_ends_at ? $plan->discount_ends_at->format('Y-m-d\TH:i') : '';
        $this->discountLabel    = $plan->discount_label ?? '';
        $this->showModal    = true;
    }
    ...
    public function save()
    {
        ...
        $data = [
            ...
            'discount_value'   => $this->discountType !== 'none' ? $this->discountValue : 0,
            'discount_starts_at' => $this->discountType !== 'none' && $this->discountStartsAt ? $this->discountStartsAt : null,
            'discount_ends_at'   => $this->discountType !== 'none' && $this->discountEndsAt ? $this->discountEndsAt : null,
            'discount_label'   => $this->discountType !== 'none' ? $this->discountLabel : null,
        ];
    ...
    private function resetForm()
    {
        $this->reset([
            ...
            'discountType', 'discountValue', 'discountStartsAt',
            'discountEndsAt', 'discountLabel',
        ]);
        $this->isActive = true;
